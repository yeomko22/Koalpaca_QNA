...
class QnaDetailSpider(scrapy.Spider):
    name = "qna_detail"
    ...
    def __init__(self, **kwargs):
        ...
        self.data = []
        with open("qna_sample.csv") as fr:
        ...
        self.output_file = open("qna_corpus.csv", "w")
